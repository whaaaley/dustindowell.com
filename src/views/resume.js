import { div, h, h1, h2, h3, li, p, span, text, ul } from '../lib/vnodes/html'
...
const Grid = () => {
  return div({ class: 'grid' }, [
    ...
    div({ class: 'grid-item' }, [
      ...
      ul([
        Text(li, 'Built dashboards in Vue2/Vue3 using serverless AWS/Node/MongoDB backend for real-time order and inventory management, using an incremental migration strategy to Vue3 without breaking existing functionality.'),
