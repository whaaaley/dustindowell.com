      ...
      return (
        ...
        >
          <div class='grid gap-t6'>
            ...
            {project.detail && (
              <Surface class='rounded-xl p-t6' tone='light'>
                ...
                <div class='my-t5 grid gap-t5 sm:grid-cols-2'>
                  {project.detail.keyFeatures.map(feature => (
                    <Surface key={feature.title} class='rounded-lg p-t5' tone='lighter'>
                ...
                <div class='my-t5 flex flex-col gap-t4'>
                  {project.detail.additionalFeatures.map(feature => (
                    <Surface key={feature.title} class='rounded-md px-t5 py-t4' tone='lighter'>
