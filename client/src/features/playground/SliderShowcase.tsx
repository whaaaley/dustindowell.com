...
const images: SliderImage[] = [
  { src: '/screenshots/compose/16_project_experiment_list.png', alt: 'Experiment list' },
  ...
  { src: '/screenshots/compose/31_experiment_report.png', alt: 'Experiment report' },
  { src: '/screenshots/compose/35_experiment_report_winner.png', alt: 'Experiment winner' },
]
